...
class BookListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_list" do
    assert_difference('BookList.count') do
      post book_lists_url, params: { book_list: { book_id: @book_list.book_id, list_id: @book_list.list_id } }
    end
  ...
  test "should update book_list" do
    patch book_list_url(@book_list), params: { book_list: { book_id: @book_list.book_id, list_id: @book_list.list_id } }
